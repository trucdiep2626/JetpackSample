...
class FirstFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.btn2.setOnClickListener {
            var user = User(name = "Amy",age = 12)
            println(user.name+user.age.toString())
//            val bundle= bundleOf(
...
//            )
         ...
         //   controller.navigate(R.id.action_firstFragment_to_secondFragment,bundle)
            ...
            val action= FirstFragmentDirections.actionFirstFragmentToSecondFragment(address = "HCM",user)
