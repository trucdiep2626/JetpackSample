...
class MySliceProvider : SliceProvider() {
    ...
    /**
     * Converts URL to content URI (i.e. content://com.example.samplejetpack...)
     */
...
//    }
    ...
    private fun createActivityAction(): SliceAction? {
       ...
       // Instead of returning null, you should create a SliceAction. Here is an example:
        return SliceAction( PendingIntent.getActivity(
            context, 0, Intent(context, NoteActivity::class.java), 0
        ),
